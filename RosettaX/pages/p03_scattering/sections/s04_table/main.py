...
class ReferenceTable:
    ...
    def get_layout(self) -> dbc.Card:
        ...
        body.children = [
            ...
            *list(body.children),
            ...
            self._build_mie_relation_graph_panel(),
        ]
    ...
    def _build_mie_relation_graph_panel(self) -> dash.html.Div:
        """
        Build the calibration standard Mie relation graph block shown with the table.
        """
        graph_style = {
