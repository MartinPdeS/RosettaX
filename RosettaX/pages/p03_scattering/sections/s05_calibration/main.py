...
def build_scattering_axis_control_block(
    *,
    x_switch_id: str,
    y_switch_id: str,
...
def build_scattering_graph_panel_card(
    *,
    color_name: str,
    graph_min_width_px: int,
    title: str,
    subtitle: str,
    ...
    card_children = [
        ...
        dbc.CardBody(
            [
                build_scattering_axis_control_block(
    ...
    return dbc.Card(
        ...
        style={
            **ui_forms.build_workflow_subpanel_card_style(
            ...
            "flex": "1 1 0",
            "minWidth": f"{graph_min_width_px}px",
        },
        class_name="h-100",
    )
...
class Calibration:
    ...
    def _build_action_panel(self) -> dash.html.Div:
        ...
        return dash.html.Div(
            [
                ...
                dbc.Checklist(
                    id=self.ids.force_zero_intercept_toggle,
                    options=[
                        {
                            "label": "Force intercept = 0",
    ...
    def _build_graph_block(self) -> dash.html.Div:
        """
        Build the instrument response graph panel.
        """
        return dash.html.Div(
            [
    ...
    def _build_graph_panel_card(
        ...
        *,
        ...
        Build one self contained graph panel card.
        """
        return build_scattering_graph_panel_card(
            color_name=self.card_color,
            graph_min_width_px=self.graph_min_width_px,
            title=title,
            subtitle=subtitle,
            tooltip_target_id=tooltip_target_id,
            tooltip_id=tooltip_id,
    ...
    def _register_fit_calibration_callback(self) -> None:
        ...
        def fit_scattering_instrument_response(
            ...
            force_zero_intercept = bool(
                isinstance(force_zero_intercept_toggle_value, list)
                and "force_zero_intercept" in force_zero_intercept_toggle_value
            )
