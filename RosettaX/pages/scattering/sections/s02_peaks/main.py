...
class Scattering:
    ...
    def register_callbacks(self) -> None:
        ...
        def populate_detector_dropdown(
            ...
            return services.populate_scattering_detector_dropdown(
        ...
        def clear_peak_lines_on_context_change(
            ...
            return services.build_empty_peak_lines_payload()
        ...
        def update_scattering_histogram(
            ...
            callback_inputs: services.ScatteringCallbackInputs = services.parse_scattering_histogram_callback_inputs(
        ...
        def find_peaks_and_update_table(
            ...
            try:
                ...
                updated_table_data = services.write_measured_peaks_into_table(
