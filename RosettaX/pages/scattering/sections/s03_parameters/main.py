...
class Parameters:
            ...
            [
                ...
                self._inline_row(
                    ...
                    dash.dcc.Dropdown(
                        ...
                        options=presets.OPTICAL_CONFIGURATION_PRESET_OPTIONS,
                        value=None,
        ...
        return dash.html.Div(
            [
                ...
                dash.dash_table.DataTable(
                    ...
                    data=services.build_empty_rows_for_model("Solid Sphere", row_count=3),
                    **styling.DATATABLE,
                ),
                dash.html.Div(
                    [
    ...
    def _register_optical_configuration_callbacks(self) -> None:
        ...
        def apply_optical_configuration_preset(
            ...
            preset = presets.OPTICAL_CONFIGURATION_PRESETS.get(str(preset_name), {})
    ...
    def _register_compute_model_callback(self) -> None:
        ...
        def compute_model(
            ...
            if not current_rows:
                ...
                return services.build_empty_rows_for_model(resolved_mie_model, row_count=3)
