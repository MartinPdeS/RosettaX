...
class Save:
    ...
    State ownership
    ---------------
    The calibration payload is read from the scattering page state store.
    """
    ...
    def _register_save_calibration_callback(self) -> None:
        ...
        def save_section_actions(
            ...
            calib_payload = page_state.calibration_payload

            logger.debug(
                "save_section_actions called with file_name=%r "
