...
from RosettaX.workflow import scattering, peak, apply_calibration
...
FIELD_DEFINITIONS: list[FieldDefinition] = [
    ...
    FieldDefinition(
        ...
        profile_path="scattering.calibration.default_gating_channel",
        default="",
    ),
    FieldDefinition(
        ...
        profile_path="scattering.calibration.default_gating_threshold",
        default=0.0,
        step=0.1,
    ),
    FieldDefinition(
    ...
    FieldDefinition(
        ...
        profile_path="apply_calibration.calibration.default_output_suffix",
        default="_calibrated",
    ),
    FieldDefinition(
        name="operator_name",
    ...
    FieldDefinition(
        ...
        profile_path="apply_calibration.calibration.show_calibration_plot_by_default",
        default=True,
