...
PROFILE_SECTION_ORDER: list[tuple[str, str]] = [
    ("fluorescence", "Fluorescence calibration"),
    ("scattering", "Scattering calibration"),
...
FIELD_DEFINITIONS: list[FieldDefinition] = [
    FieldDefinition(
        ...
        runtime_path="fluorescence_calibration.mesf_values",
        default=[],
    ),
    FieldDefinition(
        name="peak_count",
        ...
        value_kind="int",
        runtime_path="fluorescence_calibration.peak_count",
        default=4,
        min_value=1,
        max_value=10,
        step=1,
    ...
    FieldDefinition(
        ...
        section="scattering",
        label="Particle diameter list (nm):",
        component_kind="text",
        value_kind="float_list",
    ...
    FieldDefinition(
        ...
        component_kind="text",
        value_kind="string",
        runtime_path="scattering_calibration.default_gating_channel",
        default="",
    ),
    FieldDefinition(
    ...
    FieldDefinition(
        ...
        component_kind="dropdown",
        value_kind="choice",
        runtime_path="scattering_calibration.target_mie_relation_xscale",
        default="linear",
    ...
    FieldDefinition(
        ...
        component_kind="dropdown",
        value_kind="choice",
        runtime_path="scattering_calibration.target_mie_relation_yscale",
        default="log",
        options=AXIS_SCALE_OPTIONS,
    ),
    FieldDefinition(
    ...
    FieldDefinition(
        ...
        component_kind="number",
        value_kind="int",
        runtime_path="visualization.n_bins",
        default=100,
        min_value=10,
        step=10,
    ),
    FieldDefinition(
        ...
        runtime_path="visualization.show_calibration",
        default=False,
