...
class CalibrationPickerLayout:
    ...
    def __init__(
        ...
        *,
        ...
        self.header_tooltip_target_id = (
            f"{self.page.ids.CalibrationPicker.upload}-section-info-target"
        )
        self.header_tooltip_id = (
            f"{self.page.ids.CalibrationPicker.upload}-section-info-tooltip"
        )
    ...
    def _build_header(self) -> dbc.CardHeader:
        ...
        return ui_forms.build_card_header_with_info(
            title=f"{self.section_number}. Upload calibration",
            ...
            tooltip_text=(
                ...
                "Each calibration is applied to its associated source channel in the "
    ...
    def _build_picker_row(self) -> dash.html.Div:
        """
        Build the calibration upload row.
        """
        return dash.html.Div(
            [
                dash.html.Div(
    ...
    def _build_picker_status(self) -> dbc.Alert:
        """
    ...
    def _build_target_mie_relation_preview_panel(self) -> dbc.Card:
        ...
        return dash.html.Div(
            ...
            id=self.page.ids.CalibrationPicker.target_mie_relation_preview_container,
            style=services.build_scattering_target_model_container_style(
                is_visible=False,
            ),
        )
