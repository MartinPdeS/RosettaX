...
class FluorescenceSection():
        ...
        return dbc.Card(
            [
                ...
                self._fluorescence_build_body(
                    ...
                    default_peak_count=ui_flags.default_peak_count,
                    default_n_bins_for_plots=ui_flags.n_bins_for_plots,
                ),
            ]
        )
    ...
    def _fluorescence_build_histogram_graph(self) -> dcc.Loading:
        return dcc.Loading(
            dcc.Graph(
                ...
                style=self.context.graph_style,
            ),
            type="default",
        )
    ...
    def _fluorescence_register_callbacks(self) -> None:
        ...
        def refresh_fluorescence_hist_store(
            ...
            gated = self.context.service.apply_gate(
                fluorescence_values=fluorescence_values,
                scattering_values=scattering_values,
                threshold=float(threshold_value),
            )

            fig = self.context.service.make_histogram_with_lines(
        ...
        def update_fluorescence_yscale(yscale_selection, stored_figure, peak_lines):
            ...
            fig = self.context.service.add_vertical_lines(
                fig=fig,
        ...
        def _debug_click(
            ...
            if not ui_flags.fluorescence_show_fluorescence_controls:
                return dash.no_update
            ...
            max_peaks = self._as_int(
                fluorescence_peak_count,
                default=ui_flags.default_peak_count,
                min_value=1,
                max_value=100,
            )
