...
class Gating:
    ...
    def register_callbacks(self) -> None:
        ...
        def sync_controls_from_runtime_store(runtime_config_data: Any) -> tuple[Any, Any, Any]:
            defaults = services.resolve_runtime_defaults(runtime_config_data)
        ...
        def toggle_scattering_debug(debug_switch_value: Any) -> dict[str, str]:
            return services.build_debug_container_style(debug_switch_value, logger=logger)
        ...
        def update_scattering_threshold_and_histogram(
            ...
            callback_inputs = services.parse_callback_inputs(
                ...
                find_threshold_button_id=self.page.ids.Scattering.find_threshold_btn,
                detector_dropdown_id=self.page.ids.Scattering.detector_dropdown,
                nbins_input_id=self.page.ids.Scattering.nbins_input,
            )
