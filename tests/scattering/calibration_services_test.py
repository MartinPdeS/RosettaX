...
class Test_OpticalParameters:
    ...
    def test_to_parameter_payload_solid_sphere(self, mock_build_mie, valid_optical_params):
        ...
        assert result['detector_configuration_preset_name'] == ''
        assert result['effective_detector_cache_numerical_aperture'] is None
        assert result['effective_blocker_bar_numerical_aperture'] is None
        assert result['detector_has_angular_weights'] is False
